          ...
          <div className='flex items-center justify-between'>
            <div className='w-1/2 pr-12'>
              ...
              <p className='text-xl mb-10 text-teal-100'>
                Connect with your lost belongings through our advanced search
                system and helpful community.
              </p>
      ...
      <section className='py-24 px-8'>
        <div className='container mx-auto'>
          ...
          <div className='grid grid-cols-4 gap-8'>
            ...
            <Link
              to='/reportlostitem'
              className='feature-card p-8 rounded-2xl card-hover fade-in'
            >
              <div className='bg-teal-100 w-16 h-16 rounded-2xl flex items-center justify-center mb-6'>
          ...
          <div className='grid grid-cols-1 place-items-center gap-12 mb-12'>
            <div className='text-center'>
              ...
              <div className='flex justify-center space-x-4'>
                <a
                  href='#'
                  className='social-icon bg-gray-800 p-3 rounded-full hover:bg-teal-900 hover:text-teal-400 transition-all'
                >
