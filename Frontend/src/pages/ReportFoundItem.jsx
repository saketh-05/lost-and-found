...
export default function ReportFoundItem() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:5000/found-item', payload); // CHANGE THIS TO YOUR BACKEND
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {/* Sample Items */}
              <ItemCard icon={<Smartphone className="w-8 h-8 text-teal-600" />} title="iPhone 13" desc="Black case with card holder" date="April 10, 2024" />
              <ItemCard icon={<Backpack className="w-8 h-8 text-teal-600" />} title="Nike Backpack" desc="Blue with white stripes" date="April 8, 2024" />
              <ItemCard icon={<Wallet className="w-8 h-8 text-teal-600" />} title="Brown Wallet" desc="Leather with initials 'JD'" date="April 5, 2024" />
              <ItemCard icon={<Key className="w-8 h-8 text-teal-600" />} title="House Keys" desc="3 keys with red keychain" date="April 3, 2024" />
            </div>
          </div>
        </div>
      </div>
